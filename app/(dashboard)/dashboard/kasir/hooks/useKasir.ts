...
export function useKasir() {
  ...
  return {
    ...
    channelPrices, isLoading, setIsLoading, kasirMenus, cart, setCart, showCart, setShowCart, activeSection, setActiveSection,
    ...
    setSelectedBiayaEkstra, showStruk, setShowStruk, strukData, setStrukData, paketModal, setPaketModal,
